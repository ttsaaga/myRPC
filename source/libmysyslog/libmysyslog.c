...
// Путь к лог-файлу (можно сделать настраиваемым через env или define)
#define LOG_FILE "/var/log/myrpc.log"

// Получение строки уровня
...
// Внутренняя реализация логирования
static void mysyslog_internal(int level, const char *format, va_list args) {
    ...
    struct tm t;
    localtime_r(&now, &t);  // Потокобезопасный вариант
